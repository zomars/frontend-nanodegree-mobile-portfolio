...
function changeSliderLabel(size) {
  switch(size) {
    ...
    return;
    default:
    console.log('There is an error in changeSliderLabel');
  }
}
...
function sizeSwitcher (size) {
  switch(size) {
    ...
    return 0.5;
    default:
    console.log('There is an error in sizeSwitcher');
  }
}
...
var resizePizzas = function(size) {
  // User Timing API function, more info: http://www.html5rocks.com/en/tutorials/webperformance/usertiming/
  ...
  // User Timing API for performance measuring
...
// This loop creates and appends all of the pizzas when the page loads
var pizzasDiv = document.getElementById('randomPizzas');
for (var i = 2; i < 100; i++) {
  pizzasDiv.appendChild(pizzaElementGenerator(i));
}

// User Timing API for measuring how long it took to generate the initial pizzas
...
// Debounce the scroll event, more info: https://davidwalsh.name/javascript-debounce-function
var lastScrollY = 0;
var animating = false;
...
function updatePositions() {
  ...
  for (var i = 0, l = items.length; i < l; i++) {  //cached length loop
    ...
    items[i].style.transform = 'translateX(' + 100 * phase + 'px)'; //animate on translate property for increased performance
  }
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  var totalPizzas = Math.ceil(cols * rows);     // The ceil returns the nearest integer for columns.
  ...
  for (var i = 0; i < totalPizzas; i++) {
    ...
    e.style.transform = 'translate3d(0, 0, 0) translate(0px)'; // translate3d ( )
    e.height = '100';
    e.width  = '73';
    e.style.height = e.height + 'px';
    e.style.width = e.width + 'px';
    e.basicLeft = (i % cols) * s;
    e.style.left = e.basicLeft + 'px';
    e.style.top = (Math.floor(i / cols) * s) + 'px';
    movingPizzas.appendChild(e);
  }
